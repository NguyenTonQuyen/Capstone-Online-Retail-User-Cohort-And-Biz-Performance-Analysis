**Executive Summary**
The business generated £17.35M in total revenue from 5,878 customers. While sales performance is strong and peaks during the year-end season, the data shows a challenge in keeping customers active after their first purchase. The majority of the user base is in the UK, and the main goal for the next period is to reduce the high drop-off rate seen in the first month.
...
**6. User Breakdown**
    •	Context: This looks at where customers live and their current status.
    •	Insight: The United Kingdom is the primary market with 5,310 users. Other countries represent a very small part of the business.
    •	Action: Since the UK is the main revenue driver, prioritize UK-based logistics and marketing. For other regions, consider higher free-shipping thresholds to make those few orders more profitable.

<img width="1269" height="625" alt="image" src="https://github.com/user-attachments/assets/9f6989e0-3b36-41ee-bd1f-7126f09c598a" />
